...
public class DefaultTexturePack extends TexturePack {
   ...
   public void unload(Minecraft minecraft) {
      if (this.icon != null) {
         minecraft.textureManager.deleteTexture(this.texture);
      }
   ...
   public void bindTexture(Minecraft minecraft) {
      if (this.icon != null && this.texture < 0) {
         this.texture = minecraft.textureManager.allocateAndSetupTexture(this.icon);
      }

      if (this.icon != null) {
         minecraft.textureManager.bind(this.texture);
      } else {
         GL11.glBindTexture(3553, minecraft.textureManager.load("/gui/unknown_pack.png"));
      }
