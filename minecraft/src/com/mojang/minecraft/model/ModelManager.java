...
public final class ModelManager {
   ...
   private SlimeModel slime = new SlimeModel();
   private CowModel cow = new CowModel();
   private WolfModel wolf = new WolfModel();
   
   public final Model getModel(String var1) {
      return (Model)(var1.equals("humanoid") ? this.human : (var1.equals("humanoid.armor") ? this.armoredHuman : (var1.equals("chicken") ? this.chicken : (var1.equals("creeper") ? this.creeper : (var1.equals("skeleton") ? this.skeleton : (var1.equals("zombie") ? this.zombie : (var1.equals("pig") ? this.pig : (var1.equals("sheep") ? this.sheep : (var1.equals("spider") ? this.spider : (var1.equals("sheep.fur") ? this.sheepFur : (var1.equals("cow") ? this.cow : (var1.equals("slime") ? this.slime : (var1.equals("wolf") ? this.wolf : null)))))))))))));
   }
}
