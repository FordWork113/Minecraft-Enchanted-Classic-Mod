...
public class ReedsBlock extends Block {

   protected ReedsBlock(int var1, int var2) {
      super(var1);
      this.textureId = var2;
   ...
   public void update(Level level, int x, int y, int z, Random rand) {
      if(!level.growTrees) {
         ...
         if(!level.isLit(x, y, z) || var6 != Block.DIRT.id && var6 != Block.GRASS.id && var6 != Block.SNOW_GRASS.id && var6 != Block.SAND.id && var6 != Block.REEDS.id) {
   ...
   private void render(ShapeRenderer var1, float var2, float var3, float var4) {
	      ...
	      for(int var8 = 0; var8 < 2; ++var8) {
	         float var9 = (float)((double)MathHelper.sin((float)var8 * 3.1415927F / 2.0F + 0.7853982F) * 0.6D);
	         float var10 = (float)((double)MathHelper.cos((float)var8 * 3.1415927F / 2.0F + 0.7853982F) * 0.6D);
