...
public final class DirtSlabBlock extends Block {

   private boolean doubleSlab;

   public DirtSlabBlock(int var1, boolean var2) {
      super(var1, 2);
   ...
   public final void onAdded(Level level, int x, int y, int z) {
      ...
      if(level.getTile(x, y - 1, z) == DIRT_SLAB.id) {
         level.setTile(x, y, z, 0);
         level.setTile(x, y - 1, z, Block.DIRT.id);
      }

   }

   public final int getDrop() {
      return Block.DIRT_SLAB.id;
   }
