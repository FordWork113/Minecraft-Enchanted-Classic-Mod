package com.mojang.minecraft.level.tile.slab;

import com.mojang.minecraft.level.Level;
import com.mojang.minecraft.level.tile.Block;

public final class MossyCobbleSlabBlock extends Block {

   private boolean doubleSlab;

   public MossyCobbleSlabBlock(int var1, boolean var2) {
      super(var1, 36);
   ...
   public final void onNeighborChange(Level var1, int var2, int var3, int var4, int var5) {
      if(this == Block.MOSSY_COBBLESTONE_SLAB) {
         ;
      }
   }
   ...
   public final void onAdded(Level level, int x, int y, int z) {
      ...
      if(level.getTile(x, y - 1, z) == MOSSY_COBBLESTONE_SLAB.id) {
         level.setTile(x, y, z, 0);
         level.setTile(x, y - 1, z, Block.MOSSY_COBBLESTONE.id);
      }

   }

   public final int getDrop() {
      return Block.MOSSY_COBBLESTONE_SLAB.id;
   }
