...
public final class SandStoneSlabBlock extends Block {

   private boolean doubleSlab;

   public SandStoneSlabBlock(int var1, boolean var2) {
      super(var1, 43);
   ...
   public final void onAdded(Level level, int x, int y, int z) {
      ...
      if(level.getTile(x, y - 1, z) == SANDSTONE_SLAB.id) {
         level.setTile(x, y, z, 0);
         level.setTile(x, y - 1, z, Block.SANDSTONE.id);
      }

   }

   public final int getDrop() {
      return Block.SANDSTONE_SLAB.id;
   }
