...
public final class WoodSlabBlock extends Block {

   private boolean doubleSlab;

   public WoodSlabBlock(int var1, boolean var2) {
      super(var1, 4);
   ...
   public final void onAdded(Level level, int x, int y, int z) {
      ...
      if(level.getTile(x, y - 1, z) == WOOD_SLAB.id) {
         level.setTile(x, y, z, 0);
         level.setTile(x, y - 1, z, Block.WOOD.id);
      }

   }

   public final int getDrop() {
      return Block.WOOD_SLAB.id;
   }
