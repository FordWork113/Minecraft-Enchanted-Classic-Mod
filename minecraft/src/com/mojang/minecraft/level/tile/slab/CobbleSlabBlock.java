...
public final class CobbleSlabBlock extends Block {

   private boolean doubleSlab;

   public CobbleSlabBlock(int var1, boolean var2) {
      super(var1, 16);
   ...
   public final void onNeighborChange(Level var1, int var2, int var3, int var4, int var5) {
      if(this == Block.COBBLESTONE_SLAB) {
         ;
      }
   }
   ...
   public final void onAdded(Level level, int x, int y, int z) {
      ...
      if(level.getTile(x, y - 1, z) == COBBLESTONE_SLAB.id) {
         ...
         level.setTile(x, y - 1, z, Block.COBBLESTONE.id);
      }

   }

   public final int getDrop() {
      return Block.COBBLESTONE_SLAB.id;
   }
