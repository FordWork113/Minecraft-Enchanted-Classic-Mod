...
public final class BrickSlabBlock extends Block {

   private boolean doubleSlab;

   public BrickSlabBlock(int var1, boolean var2) {
      super(var1, 7);
   ...
   public final void onAdded(Level level, int x, int y, int z) {
      ...
      if(level.getTile(x, y - 1, z) == BRICK_SLAB.id) {
         level.setTile(x, y, z, 0);
         level.setTile(x, y - 1, z, Block.BRICK.id);
      }

   }

   public final int getDrop() {
      return Block.BRICK_SLAB.id;
   }
