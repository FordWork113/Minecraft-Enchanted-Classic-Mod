...
public final class StoneSlabBlock extends Block {

   private boolean doubleSlab;

   public StoneSlabBlock(int var1, boolean var2) {
      super(var1, 1);
   ...
   public final void onAdded(Level level, int x, int y, int z) {
      ...
      if(level.getTile(x, y - 1, z) == STONE_SLAB.id) {
         level.setTile(x, y, z, 0);
         level.setTile(x, y - 1, z, Block.STONE.id);
      }
