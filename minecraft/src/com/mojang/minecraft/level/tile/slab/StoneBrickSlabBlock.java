...
public final class StoneBrickSlabBlock extends Block {

   private boolean doubleSlab;

   public StoneBrickSlabBlock(int var1, boolean var2) {
      super(var1, 100);
   ...
   public final void onAdded(Level level, int x, int y, int z) {
      ...
      if(level.getTile(x, y - 1, z) == STONEBRICK_SLAB.id) {
         level.setTile(x, y, z, 0);
         level.setTile(x, y - 1, z, Block.STONEBRICK.id);
      }

   }

   public final int getDrop() {
      return Block.STONEBRICK_SLAB.id;
   }
