...
public final class LeavesBlock extends LeavesBaseBlock {
   ...
   public final int getDrop(Level level, Random rand) {
	   if(rand.nextInt(2) != 0) { 
		 return Items.stick.shiftedIndex;
		   ...
		   return this == Block.LEAVES?Block.SAPLING.id:(this == Block.BIRCH_LEAVES?Block.BIRCH_SAPLING.id:(this == Block.OTHER_REDBERRY_LEAVES?Block.REDBERRY_SAPLING.id:(this == Block.OTHER_BLACKBERRY_LEAVES?Block.BLACKBERRY_SAPLING.id:this.id)));
	   } else {
   ...
   public final void setFancy(boolean var1) {
	  ...
	  this.textureId = this.oldTexture + (var1 ? 0 : 93);
   }
