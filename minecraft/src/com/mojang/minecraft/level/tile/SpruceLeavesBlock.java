...
public final class SpruceLeavesBlock extends LeavesBaseBlock {
   
   protected SpruceLeavesBlock(int var1, int var2) {
   ...
   public final int getDrop(Level level, Random rand) {
	   if(rand.nextInt(2) != 0) { 
		 return Items.stick.shiftedIndex;
		   ...
		   return this == Block.SPRUCE_LEAVES?Block.SPRUCE_SAPLING.id:this.id;
	   } else {
   ...
   public final void setFancy(boolean var1) {
	  ...
	  this.textureId = this.oldTexture + (var1 ? 0 : 78);
   }
