...
public class CristalBlock extends Block {

   protected CristalBlock(int var1, int var2) {
      super(var1);
      this.textureId = var2;
   ...
   private void render(ShapeRenderer var1, float var2, float var3, float var4) {
	      ...
	      for(int var8 = 0; var8 < 2; ++var8) {
	         float var9 = (float)((double)MathHelper.sin((float)var8 * 3.1415927F / 2.0F + 0.7853982F) * 0.65D);
	         float var10 = (float)((double)MathHelper.cos((float)var8 * 3.1415927F / 2.0F + 0.7853982F) * 0.65D);
