...
import com.mojang.minecraft.level.EntityMap$Slot;
...
public class EntityMap implements Serializable {
   ...
   private int depth;
   private int height;
   public EntityMap$Slot slot = new EntityMap$Slot(this, (SyntheticClass)null);
   public EntityMap$Slot slot2 = new EntityMap$Slot(this, (SyntheticClass)null);
   ...
   public void moved(Entity var1) {
      EntityMap$Slot var2 = this.slot.init(var1.xOld, var1.yOld, var1.zOld);
      EntityMap$Slot var3 = this.slot2.init(var1.x, var1.y, var1.z);
      if(!var2.equals(var3)) {
         var2.remove(var1);
         var3.add(var1);
         var1.xOld = var1.x;
   ...
   public List getEntities(Entity var1, float var2, float var3, float var4, float var5, float var6, float var7, List var8) {
      EntityMap$Slot var9 = this.slot.init(var2, var3, var4);
      EntityMap$Slot var10 = this.slot2.init(var5, var6, var7);

      for(int var11 = EntityMap$Slot.getXSlot(var9) - 1; var11 <= EntityMap$Slot.getXSlot(var10) + 1; ++var11) {
         for(int var12 = EntityMap$Slot.getYSlot(var9) - 1; var12 <= EntityMap$Slot.getYSlot(var10) + 1; ++var12) {
            for(int var13 = EntityMap$Slot.getZSlot(var9) - 1; var13 <= EntityMap$Slot.getZSlot(var10) + 1; ++var13) {
                  ...
                  if(var2.isBoxInFrustrum(var6, var9, var13, var7, var10, var14)) {
                     ...
                     for(int var23 = 0; var23 < var12.size(); ++var23) {
                        ...
                        if((var22 = (Entity)var12.get(var23)).shouldRender(var1)) {
                           ...
                           float var28 = var22.xRot + (var22.yRot - var22.xRot) * var4;
   ...
   static int getWidth(EntityMap var0) {
      return var0.width;
   }

   static int getDepth(EntityMap var0) {
      return var0.depth;
   }

   static int getHeight(EntityMap var0) {
      return var0.height;
   }
}
