...
public final class MobSpawner {
   ...
   public final int spawn(int var1, Entity var2, ProgressBarDisplay var3) {
      ...
      for(int var5 = 0; var5 < var1; ++var5) {
         ...
         int var6 = this.level.random.nextInt(9);
         ...
         if (!this.level.isSolidTile(var7, var8, var9) && this.level.getLiquid(var7, var8, var9) == LiquidType.NOT_LIQUID && (!this.level.isLit(var7, var8, var9) || this.level.isSolidTile(var6, var7 - 1, var8) && this.level.getTile(var6, var7, var8) != Block.ICE.id || this.level.random.nextInt(5) == 0)) {
            for(int var10 = 0; var10 < 3; ++var10) {
               ...
               for(int var14 = 0; var14 < 3; ++var14) {
                  ...
                  if (var11 >= 0 && var13 >= 1 && var12 >= 0 && var12 < this.level.height - 2 && var11 < this.level.width && var13 < this.level.depth && this.level.isSolidTile(var11, var12 - 1, var13) && !this.level.isSolidTile(var11, var12, var13) && !this.level.isSolidTile(var11, var12 + 1, var13)) {
                     ...
                     if (var6 == 8) {
                         var21 = new Wolf(this.level, var15, var16, var17);
                     }
