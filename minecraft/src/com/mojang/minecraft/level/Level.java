...
//import com.mojang.minecraft.level.path.Pathfinder;
...
public class Level implements Serializable {
   ...
   public transient FontRenderer font;
   public Weather weather;
   public int gamemode;
   public static boolean growthGrass;
   ...
   public void initTransient() {
      if(this.blocks == null) {
         ...
         if (this.cloudHeight == 0) {
        	 this.cloudHeight = this.depth + 2;
		 }
         ...
         if(this.entityMap == null) {
            this.entityMap = new EntityMap(this.width, this.depth, this.height);
         }
         
         if(this.levelType == 1 || this.levelType == 2) {
       	    this.growthGrass = false;
         }
   ...
   /*public void findSpawn() {
	      ...
	      do {
	         ++var2;
	         var3 = var1.nextInt(this.width / 2) + this.width / 2;
	         var4 = var1.nextInt(this.height / 2) + this.height / 4;
	         var5 = var6.getHighestTile(var3, var4) + 1;
	         if (var2 == 10000) {
	            this.xSpawn = var3;
	            this.ySpawn = -100;
	            this.zSpawn = var4;
	            ...
	            for(int var10 = var7; var10 < var8; ++var10) {
	               ...
	               if(var3 >= 0 && var9 >= 0 && var10 >= 0 && var3 < this.width && var9 < this.depth && var10 < this.height) {
	                  ...
	                  if((var12 = Block.blocks[this.getTile(var3, var9, var10)]) != null && (var11 = var12.getCollisionBox(var3, var9, var10)) != null && var1.intersectsInner(var11)) {
	                   ...
	                   var2.add(var11);
	               } /*else if(this.borderType == 1 && this.groundLevel < 0 && (var9 < this.groundLevel || var9 < this.waterLevel) && (var11 = Block.BEDROCK.getCollisionBox(var3, var9, var10)) != null && var1.intersectsInner(var11)) {
	                   var2.add(var11);
	               }*/
	            }
	         }
   ...
   public boolean isFree(AABB var1) {
      return this.entityMap.getEntities((Entity)null, var1).size() == 0;
   }

   public List findEntities(Entity var1, AABB var2) {
      return this.entityMap.getEntities(var1, var2);
   }
   ...
   public boolean isSolid(float var1, float var2, float var3) {
      int var4;
   ...
   public boolean isLava(int var1, int var2, int var3) {
	  int var4;
	  return (var4 = this.getTile(var1, var2, var3)) > 0 && Block.blocks[var4].getLiquidType() == LiquidType.LAVA;
   }
   ...
   public void playSound(String var1, Entity var2, float var3, float var4) {
      if(this.rendererContext$5cd64a7f != null && !this.rendererContext$5cd64a7f.waiting) {
         Minecraft var5;
   ...
   public boolean maybeGrowTree(int var1, int var2, int var3) {
	      ...
	      if(var2 > 0 && var2 + var4 + 1 <= this.depth) {
	      int var6;
	      int var8;
	      int var9;
	      ...
	      if(!var5) {
	         return false;
	      } else if((this.blocks[((var2 - 1) * this.height + var3) * this.width + var1] & 255) == Block.GRASS.id && var2 < this.depth - var4 - 1 || (this.blocks[((var2 - 1) * this.height + var3) * this.width + var1] & 255) == Block.DIRT.id && var2 < this.depth - var4 - 1 || (this.blocks[((var2 - 1) * this.height + var3) * this.width + var1] & 255) == Block.SNOW_GRASS.id && var2 < this.depth - var4 - 1) {
	            ...
	            for(int var10 = var1 - var9; var10 <= var1 + var9; ++var10) {
	               ...
	               for(var6 = var3 - var9; var6 <= var3 + var9; ++var6) {
	                  ...
	                  if(Math.abs(var12) != var9 || Math.abs(var11) != var9 || this.random.nextInt(2) != 0 && var8 != 0) {
	                   ...
	                   if(this.levelType == 2) {
	                	 this.setTile(var10, var13, var6, Block.SNOW_LEAVES.id);
	                  }
	               }
	               }
	            }
   ...
   public boolean maybeGrowBirchTree(int var1, int var2, int var3) {
	      int var4 = this.random.nextInt(5) + 4;
	      boolean var5 = true;
	      ...
	      if(!var5) {
	         ...
	         for(var13 = var2 - 3 + var4; var13 <= var2 + var4; ++var13) {
	            ...
	            for(int var10 = var1 - var9; var10 <= var1 + var9; ++var10) {
	               ...
	               for(var6 = var3 - var9; var6 <= var3 + var9; ++var6) {
	                  int var11 = var6 - var3;
	                  if(Math.abs(var12) != var9 || Math.abs(var11) != var9 || this.random.nextInt(2) != 0 && var8 != 0) {
	                     this.setTile(var10, var13, var6, Block.BIRCH_LEAVES.id);
	                     if(this.levelType == 2) {
		                	 this.setTile(var10, var13, var6, Block.SNOW_BIRCH_LEAVES.id);
		                 }
	                  }
	               }
	            }
	         ...
	         for(var13 = 0; var13 < var4; ++var13) {
	              this.setTile(var1, var2 + var13, var3, Block.BIRCH_LOG.id);
	         }
   ...
   public boolean maybeGrowSpruceTree(Level var1, Random var2, int var3, int var4, int var5) {
	      int var6 = var2.nextInt(4) + 6;
	      int var7 = 1 + var2.nextInt(2);
	      int var8 = var6 - var7;
	      int var9 = 2 + var2.nextInt(2);
	      boolean var10 = true;
	      if (var4 >= 1 && var4 + var6 + 1 <= this.depth) {
	         int var11;
	         int var13;
	         int var15;
	         int var21;
	         for(var11 = var4; var11 <= var4 + 1 + var6 && var10; ++var11) {
	            ...
	            for(var13 = var3 - var21; var13 <= var3 + var21 && var10; ++var13) {
	               for(int var14 = var5 - var21; var14 <= var5 + var21 && var10; ++var14) {
	                  if (var11 >= 0 && var11 < this.depth) {
	                     var15 = var1.getTile(var13, var11, var14);
	                     if (var15 != 0 && var15 != Block.SPRUCE_LEAVES.id) {
	                        var10 = false;
	                     }
	                  } else {
	                     var10 = false;
	         ...
	         if (!var10) {
	            ...
	            if((this.blocks[((var4 - 1) * this.height + var5) * this.width + var3] & 255) == Block.GRASS.id && var4 < this.depth - var6 - 1 || (this.blocks[((var4 - 1) * this.height + var5) * this.width + var3] & 255) == Block.SNOW_GRASS.id && var4 < this.depth - var6 - 1 || (this.blocks[((var4 - 1) * this.height + var5) * this.width + var3] & 255) == Block.DIRT.id && var4 < this.depth - var6 - 1) {
	               var1.setTileNoUpdate(var3, var4 - 1, var5, Block.DIRT.id);
	               ...
	               for(var15 = 0; var15 <= var8; ++var15) {
	                  ...
	                  for(var17 = var3 - var21; var17 <= var3 + var21; ++var17) {
	                     ...
	                     for(int var19 = var5 - var21; var19 <= var5 + var21; ++var19) {
	                        ...
	                        if ((Math.abs(var18) != var21 || Math.abs(var20) != var21 || var21 <= 0) && !var1.isSolid(var17, var16, var19)) {
	                           var1.setTile(var17, var16, var19, Block.SPRUCE_LEAVES.id);
	                           if(this.levelType == 2) {
	                        	 var1.setTile(var17, var16, var19, Block.SNOW_SPRUCE_LEAVES.id);  
	                           }
	                        }
	                     }
	                  }
	               ...
	               for(var16 = 0; var16 < var6 - var15; ++var16) {
	                  var1.setTile(var3, var4 + var16, var5, Block.SPRUCE_LOG.id);
	               }
   ...
   public boolean maybeGrowRedTree(int var1, int var2, int var3) {
	      int var4 = this.random.nextInt(3) + 4;
	      boolean var5 = true;
	         ...
	         for(var13 = var2 - 3 + var4; var13 <= var2 + var4; ++var13) {
	            ...
	            for(int var10 = var1 - var9; var10 <= var1 + var9; ++var10) {
	               ...
	               for(var6 = var3 - var9; var6 <= var3 + var9; ++var6) {
	                  int var11 = var6 - var3;
	                  if(Math.abs(var12) != var9 || Math.abs(var11) != var9 || this.random.nextInt(2) != 0 && var8 != 0) {
	                     this.setTile(var10, var13, var6, Block.OTHER_REDBERRY_LEAVES.id);
	                     if(this.random.nextInt(100) / 60 != 0) {
			                 this.setTile(var10, var13, var6, Block.REDBERRY_LEAVES.id);             	  
		                }
	                     
	                    if(this.levelType == 2) {
		                 this.setTile(var10, var13, var6, Block.SNOW_OTHER_REDBERRY_LEAVES.id);
		                }
	                  }
	               }
	            }
   ...
   public boolean maybeGrowBlackTree(int var1, int var2, int var3) {
	      int var4 = this.random.nextInt(3) + 4;
	      boolean var5 = true;
	         ...
	         for(var13 = var2 - 3 + var4; var13 <= var2 + var4; ++var13) {
	            ...
	            for(int var10 = var1 - var9; var10 <= var1 + var9; ++var10) {
	               ...
	               for(var6 = var3 - var9; var6 <= var3 + var9; ++var6) {
	                  int var11 = var6 - var3;
	                  if(Math.abs(var12) != var9 || Math.abs(var11) != var9 || this.random.nextInt(2) != 0 && var8 != 0) {
	                     this.setTile(var10, var13, var6, Block.OTHER_BLACKBERRY_LEAVES.id);
	                     if(this.random.nextInt(100) / 60 != 0) {
			                 this.setTile(var10, var13, var6, Block.BLACKBERRY_LEAVES.id);             	  
		                }
	                     
	                    if(this.levelType == 2) {
		                 this.setTile(var10, var13, var6, Block.SNOW_OTHER_BLACKBERRY_LEAVES.id);
		                }
	                  }
	               }
	            }
   ...
   public boolean reedsSpawn(Level var1, Random var2, int var3, int var4, int var5) {
	      for(int var66 = 0; var66 < 20; ++var66) {
	         int var7 = var3 + var2.nextInt(4) - var2.nextInt(4);
	         int var8 = var4;
	         int var9 = var5 + var2.nextInt(4) - var2.nextInt(4);
	         boolean var15 = true;
	         int var78 = this.random.nextInt(2) + 2;

		      for(int var67 = var4; var67 <= var4 + 1 + var78; ++var67) {
			         byte byte2 = 1;
			         if (var67 == var4) {
			            var7 = 0;
			         }

			         if (var67 >= var4 + 1 + var78 - 2) {
			            var7 = 2;
			         }

			         for(int var87 = var3 - byte2; var87 <= var3 + byte2 && var15; ++var87) {
			            for(int var91 = var3 - byte2; var91 <= var5 + byte2 && var15; ++var91) {
			               if (var87 >= 0 && var67 >= 0 && var91 >= 0 && var8 < this.width && var67 < this.depth && var9 < this.height) {
			                  if ((this.blocks[(var67 * this.height + var9) * this.width + var8] & 255) != 0) {
			                     var15 = false;
			                  }
			               } else {
			                  var15 = false;
	         ...
	         if (var1.isSolidTile(var7, var4, var9) && (var1.getLiquid(var7 - 1, var4 - 1, var9) == LiquidType.WATER || var1.getLiquid(var7 + 1, var4 - 1, var9) == LiquidType.WATER || var1.getLiquid(var7, var4 - 1, var9 - 1) == LiquidType.WATER || var1.getLiquid(var7, var4 - 1, var9 + 1) == LiquidType.WATER)) {
	            int var10 = 2 + var2.nextInt(var2.nextInt(3) + 1);

	            if ((this.blocks[((var4 - 1) * this.height + var5) * this.width + var3] & 255) == Block.GRASS.id && var4 < this.depth - var5 - 1) {
	            for(int var11 = 0; var11 < var10; ++var11) {
	               var1.setTileNoUpdate(var7, var8 + var11, var9, Block.REEDS.id);
	            }
	            }
	         }
	      }
   ...
   public boolean cactusSpawn(int var1, int var2, int var3) {
	      int var4 = this.random.nextInt(2) + 2;
	      boolean var5 = true;
	      ...
	      if(!var5) {
	         return false;
	      } else if((this.blocks[((var2 - 1) * this.height + var3) * this.width + var1] & 255) == Block.SAND.id && var2 < this.depth - var4 - 1) {
			         for(int var13 = 0; var13 < var4; ++var13) {
			            this.setTile(var1, var2 + var13, var3, Block.CACTUS.id);
			         }
   ...
   public void createDungeon(Level level, int x, int y, int z) {
	      int var1;
	      int var2;
	      int var3;
	      for(var1 = x - 3; var1 <= x + 3; ++var1) {
	         for(var2 = z - 4; var2 <= z + 4; ++var2) {
	            var3 = this.random.nextInt(2);
	            if (var3 == 0) {
	               level.setTile(var1, y, var2, Block.MOSSY_COBBLESTONE.id);
	            } else {
	               level.setTile(var1, y, var2, Block.COBBLESTONE.id);
	            }
	         }
	      }
	      ...
	      for(var1 = x - 3; var1 <= x + 3; ++var1) {
	         for(var2 = z - 4; var2 <= z + 4; ++var2) {
	            for(var3 = y - 0; var3 <= y + 3; ++var3) {
	               if (level.getTile(var1, var3 + 1, var2) != 0) {
	                  level.setTile(var1, var3 + 1, var2, Block.COBBLESTONE.id);
	               }
	            }
	         }
	      }

	      for(var1 = x - 2; var1 <= x + 2; ++var1) {
	         for(var2 = z - 3; var2 <= z + 3; ++var2) {
	            for(var3 = y - 0; var3 <= y + 3; ++var3) {
	               if (level.getTile(var1, var3 + 1, var2) != 0) {
	                  level.setTile(var1, var3 + 1, var2, 0);
	               }
	            }
	         }
	      }
		...
		for(int var5 = var2 - 3; var5 <= var2 + 3; ++var5) {
			for(int var6 = var3 - 2; var6 <= var3 + 2; ++var6) {
				for(int var7 = var4 - 3; var7 <= var4 + 3; ++var7) {
					...
					level.setTile(var5, var6, var7, var8);
				}
			}
		}
   }
   ...
   public void explode(Entity var1, float var2, float var3, float var4, float var5) {
	  this.playSound("random.explode", var2, var3, var4, 0.5F, 1.0F);
      ...
      List var18 = this.entityMap.getEntities(var1, (float)var6, (float)var8, (float)var10, (float)var7, (float)var9, (float)var11);
   ...
   public void removeAllNonCreativeModeEntities() {
      this.entityMap.removeAllNonCreativeModeEntities();
   }

   public Vec3D cloudcolor() {
	      float var3 = (float)(Math.cos(3.1415927F * 2.0F) * 2.0F + 0.5F);
	      if (var3 < 0.0F) {
	         var3 = 0.0F;
	      }
	      ...
	      return Vec3D.newTemp((float)var4, (float)var5, (float)var6);
   }
   
	public final void releaseSkin(Entity var1) {
		this.entityMap.insert(var1);
	}
	
	public final void randomUpdates(int n2, int n3, int n4) {
		for(int j = 0; j < 20; ++j) {
		   int n7 = n2 + this.random.nextInt(16) - this.random.nextInt(16);
		   int n5;
		   int n6;
		   int n8 = this.getTile(n7, n6 = n3 + this.random.nextInt(16) - this.random.nextInt(16), n5 = n4 + this.random.nextInt(16) - this.random.nextInt(16));
		   if (n8 > 0 && this.rendererContext$5cd64a7f.settings.particles) {
		      Block.blocks[n8].randomTick(this, n7, n6, n5, this.random);
		   }
		}

	}
	
	   public boolean nearProximity(AABB var1, int var2) {
		      int var3 = (int)var1.x0;
		      int var4 = (int)var1.x1 + 1;
		      int var5 = (int)var1.y0;
		      int var6 = (int)var1.y1 + 1;
		      ...
		      for(int var11 = var3; var11 < var4; ++var11) {
		         for(var3 = var5; var3 < var6; ++var3) {
		            for(int var9 = var7; var9 < var8; ++var9) {
		               Block var10;
		               if ((var10 = Block.blocks[this.getTile(var11, var3, var9)]) != null && var10.id == var2) {
		                  return true;
		               }
		            }
		         }
	   ...
	   public final void playSoundPlayer(float float1, float float2, float float3, String string, float float5, float float6) {
		      try {
		         float n = 16.0F;
		         if (float5 > 1.0F) {
		            n = 16.0F * float5;
		         ...
		         float n2 = float1 - this.rendererContext$5cd64a7f.cameraMob.x;
		         float n3 = float2 - this.rendererContext$5cd64a7f.cameraMob.y;
		         float n4 = float3 - this.rendererContext$5cd64a7f.cameraMob.z;
		         if (n2 * n2 + n3 * n3 + n4 * n4 < n * n) {
		            this.playSound(string, float1, float2 - this.rendererContext$5cd64a7f.cameraMob.heightOffset, float3, float5, float6);
		         }
