...
public final class PathEntity {
	...
	public final Vec3D getPosition(Entity var1) {
		float var2 = (float)this.points[this.pathIndex].xCoord + (float)((int)(var1.bbWidth + 1.0F)) * 0.5F;
		float var3 = (float)this.points[this.pathIndex].yCoord;
		float var4 = (float)this.points[this.pathIndex].zCoord + (float)((int)(var1.bbWidth + 1.0F)) * 0.5F;
