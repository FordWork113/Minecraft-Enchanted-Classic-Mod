...
public class Screen {
   ...
   public static void drawCenteredStringNoShadow(FontRenderer var0, String var1, int var2, int var3, int var4) {
	  var0.renderNoShadow(var1, var2 - var0.getWidth(var1) / 2, var3, var4);
  }

   public static void drawStringNoShadow(FontRenderer var0, String var1, int var2, int var3, int var4) {
	      var0.render(var1, var2 - var0.getWidth(var1) / 2, var3, var4);
   }
