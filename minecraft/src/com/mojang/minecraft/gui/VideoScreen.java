...
public final class VideoScreen extends GuiScreen {

   private GuiScreen parent;
   private String title = "Video Settings";
   private GameSettings settings;
   public OptionsScreen renderfromtitle;

   public VideoScreen(GuiScreen var1, GameSettings var2) {
	  this.parent = var1;
	  this.settings = var2;
   }
   ...
   public final void onOpen() {
	  ...
	  int var1;
      for(var1 = 8; var1 < this.settings.settingCount; ++var1) {
          this.buttons.add(new OptionButton(var1, this.width / 2 - 155 + var1 % 2 * 160, this.height / 6 - 96 + 24 * (var1 >> 1), this.settings.getSetting(var1)));
      }
   ...
   protected void onKeyPress(char var1, int var2) {
	      if(var2 == 1 && this.minecraft.level != null || this.minecraft.level == null) {
	    	  this.minecraft.setCurrentScreen(this.parent);
	      }
