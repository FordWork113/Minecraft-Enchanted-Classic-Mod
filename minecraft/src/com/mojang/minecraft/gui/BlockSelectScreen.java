...
public final class BlockSelectScreen extends GuiScreen {
   ...
   private int getBlockOnScreen(int var1, int var2) {
        if(this.minecraft.networkManager != null) {
	         ...
	         int var4 = this.width / 2 + var3 % 13 * 24 + -156 - 3;
	         int var5 = this.height / 2 + var3 / 13 * 24 + -80 + 3;
	         if (var1 >= var4 && var1 <= var4 + 24 && var2 >= var5 - 12 && var2 <= var5 + 12) {
	            return var3;
	         }
	      }
	   ...
	   public final void render(int var1, int var2) {
	      ...
	      drawFadingBox(this.width / 2 - 168, 10, this.width / 2 + 168, 224, -1878719232, -1070583712);
	      if (var1 >= 0) {
		  ...
		  drawCenteredString(this.fontRenderer, "Select block", this.width / 2, 20, 16777215);
	      ...
	      for(var2 = 0; var2 < 42; ++var2) {
	         ...
	         Block var4 = (Block)SessionData.allowedBlocks.get(var2);
	         GL11.glPushMatrix();
	         int var5 = this.width / 2 + var2 % 13 * 24 + -156;
	         int var6 = this.height / 2 + var2 / 13 * 24 + -80;
	         GL11.glTranslatef((float)var5, (float)var6, 0.0F);
	         GL11.glScalef(10.0F, 10.0F, 10.0F);
	         GL11.glTranslatef(1.0F, 0.5F, 8.0F);
	         GL11.glRotatef(-30.0F, 1.0F, 0.0F, 0.0F);
