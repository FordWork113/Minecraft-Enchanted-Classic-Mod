...
public class Sheep extends QuadrupedMob {
  ...
  public void die(Entity var1) {
      ...
      for(int var3 = 0; var3 < var2; ++var3) {
         this.level.addEntity(new Item(this.level, this.x, this.y, this.z, new ItemStack(Items.mutton.shiftedIndex)));
      }
      ...
      if(this.hasFur) {
          ...
          for(var2 = 0; var2 < var3; ++var2) {
             this.level.addEntity(new Item(this.level, this.x, this.y, this.z, new ItemStack(Block.WHITE_WOOL.id)));
          }
